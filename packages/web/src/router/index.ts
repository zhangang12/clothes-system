...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'contracts/new', name: 'ContractCreate', component: () => import('../views/contract/ContractEditView.vue') },
      { path: 'contracts/:id/edit', name: 'ContractEdit', component: () => import('../views/contract/ContractEditView.vue') },
      ...
      { path: 'export-invoices', name: 'ExportInvoices', component: () => import('../views/invoice/ExportInvoiceView.vue') },
