        ...
        <el-table-column label="操作" width="190" fixed="right">
          ...
          <template #default="{ row }">
            <div class="table-ops">
              ...
              <el-button v-if="isAdmin" link type="primary" size="small" @click="openGrantList(row)">授权</el-button>
...
.grant-hint { font-size: 13px; color: var(--el-text-color-secondary); margin-bottom: 10px; }
</style>
