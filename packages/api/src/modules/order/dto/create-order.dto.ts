...
export class CreateOrderMaterialDto {
  ...
  @ApiPropertyOptional({ description: 'NONE/BY_SIZE/BY_COLOR/BY_BOTH' }) @IsOptional() @IsIn(['NONE', 'BY_SIZE', 'BY_COLOR', 'BY_BOTH']) split_mode?: string;
...
export class CreateOrderDto {
  ...
  @ApiPropertyOptional({ description: '整单核算模式 NONE/BY_SIZE/BY_COLOR/BY_BOTH' }) @IsOptional() @IsIn(['NONE', 'BY_SIZE', 'BY_COLOR', 'BY_BOTH']) split_mode?: string;
